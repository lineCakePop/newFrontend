    ...
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API_PROXY}/user/friendWishlist`,
        {
          params: {
            id: idToken,
            // id: "eyJraWQiOiI3MTU5ZTNlYWUwZjdmMmQ4NjhmM2MwOWI2ZGU5MzBlYzMzNjNlYzA0NTI2ZjQwY2FlYzliMWYwOGUwZjQzY2E2IiwidHlwIjoiSldUIiwiYWxnIjoiRVMyNTYifQ..Z3M8aOoZOfr9L17Rhn2I1a4q7xFmCELkZtEiXSHPJJY-hiXVUDcIm80g-IqJ_V48_0BVtIWuUFY0YaOSmDEIGA",
          },
        },
      );
